...
export interface VariantPriceUpdate {
   ...
   * £20, someone changed it to £23 in the Shopify admin, and saving £21 from the
   * old page would silently discard the £23.
   */
...
export interface ProductEditRequest {
   ...
   *
   * Status is worth guarding for the same reason as price: it decides whether
 ...
 * extra Shopify query is only worth it when there is something to compare.
 */
